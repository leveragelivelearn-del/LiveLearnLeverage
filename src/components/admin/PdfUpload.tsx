...
export function PdfUpload({ onUploadComplete, existingFile }: PdfUploadProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      {existingFile && !file && (
        <Card>
          <CardHeader>
            <CardTitle className="text-lg">Current PDF Preview</CardTitle>
            <CardDescription>
              PDF attached to this deal
            </CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-lg">
            {existingFile ? 'Replace PDF File' : 'Upload PDF Document'}
          </CardTitle>
          <CardDescription>
            Upload PDF presentation (.pdf)
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          >
            ...
            <p className="text-xs text-gray-500">
              Max file size: 50MB • PDF files only
            </p>
          </div>
